...
object AbstractMachine {
  ...
  def execute(program: Executable, initialEnv: List[Int]): Int = {
    ...
    try {
      while (frame.code.nonEmpty) {
        ...
        inst match {
          ...
          case Eq =>
            val c2 = popInt()
            val c1 = popInt()
            frame.opstack.push(if c1 == c2 then IntVal(1) else IntVal(0))
          case Lt =>
            val c2 = popInt()
            val c1 = popInt()
            frame.opstack.push(if c1 < c2 then IntVal(1) else IntVal(0))
          ...
          case And =>
            val c2 = popInt()
            val c1 = popInt()
            frame.opstack.push(if c1 + c2 >= 2 then IntVal(1) else IntVal(0))
          case Or =>
            val c2 = popInt()
            val c1 = popInt()
            frame.opstack.push(if c1 + c2 >= 1 then IntVal(1) else IntVal(0))
          case Neg =>
            val c = popInt()
            frame.opstack.push(IntVal(-c))
          case Not =>
            val c = popInt()
            frame.opstack.push(if c == 0 then IntVal(1) else IntVal(0))
          case Dup =>
          ...
          case Lambda(freeids, body) =>
            ...
            frame.opstack.push(ClosureVal(body, env))
      ...
      case ex: Exception => throw AbstractMachineError(ex)
    }
  }
